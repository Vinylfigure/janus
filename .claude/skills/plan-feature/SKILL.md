...
4. Write the plan: **Approach** (the design, the key tradeoff you made, and the alternative you rejected — one line on why), files to touch, sequencing, risks, **Unknowns:** anything still open and the route that resolves it, and **Done means:** the exact command(s)/observation(s) that prove success.
