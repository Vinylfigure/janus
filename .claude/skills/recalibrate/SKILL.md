...
3. Fetch, starting from the indexes so new material surfaces without being named in advance:
   ...
   - `github.blog/changelog` — the platform that owns the bus (issues, PRs, agent orchestration); a platform shipping a mechanism this scaffold encodes is a shed-or-justify trigger (L-015, L-043)
